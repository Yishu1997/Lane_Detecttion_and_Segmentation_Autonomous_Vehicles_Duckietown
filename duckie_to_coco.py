# -*- coding: utf-8 -*-
"""
Created on Tue Dec  8 18:49:16 2020
...
image_folder="C:/Yishu/dataset_js_02/image_2020_12_04_11_25_04/w_bezier/rgb_orig"
mask_folder="C:/Yishu/dataset_js_02/image_2020_12_04_11_25_04/w_bezier/labels"
...
h, w = 320,240
mask_reshaped = mask_flattened.reshape(h,w)
...
files = orig_files[0:175]
import os
images = []
basename_to_id = {}
for i, file in enumerate(files):
    basename = os.path.basename(file)
    entry = {"file_name":basename, "height":320, "width":240, "id":i}
